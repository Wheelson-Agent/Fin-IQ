...
/**
 * Create the generic outbound delivery log table on demand.
 * The table is intentionally channel-neutral so future WhatsApp/Teams sends use the same audit surface.
 */
...
/**
 * Persist a send attempt result without exposing provider secrets.
 */
